...
$(DATA_DIR_PROCESSED)/acs5_2020_languageshortform_tracts.csv: | $(DATA_DIR_PROCESSED)
	pipenv run mycensusdatadownloader --data-dir $(DATA_DIR) --year 2020 languageshortform tracts
