...
class ZctasDownloader2020(BaseDownloader):
    """
    Download 5-digit ZIP Code Tabulation Area
    """
    YEAR = 2020
    # Docs pg 62 https://www2.census.gov/geo/pdfs/maps-data/data/tiger/tgrshp2020/TGRSHP2020_TechDoc_Ch3.pdf
    ...
    @property
    def url(self):
        return "https://www2.census.gov/geo/tiger/TIGER2020/ZCTA5/tl_2020_us_zcta510.zip"

    @property
    def zip_name(self):
        return f"tl_2020_us_zcta510.zip"
